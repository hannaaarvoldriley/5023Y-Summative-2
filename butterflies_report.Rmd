...
Several models were trialled with different variables included while finding the best fitting multiple linear regression model, with the accepted model including thorax dry weight as a predictor in addition to inbreeding coefficient and excluding rest of body weight. The analysis of variance for the chosen model showed that thorax dry weight has on average a 3.1 unit decrease in flight inhibition index per mg increase in thorax mass (95% CI: -5.92 to -0.28) (F1,309 = 4.69, P = 0.031, R² = 0.058, Figure 1). The thorax contains predominantly flight muscles and greater thoracic mass is positively associated with flight performance (Srygley & Chai, 1990) so this result is not unexpected. Further research should investigate the relationship between genetic diversity and thoracic muscle development to better understand the mechanism by which inbreeding depression affects flight inhibition.
